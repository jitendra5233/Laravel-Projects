          ...
          <div class="card-body">
              <div class="row">
                  <div class="mb-3 col-md-12">
                    <label for="description" class="form-label">Who We Are</label>
...
$(document).ready(function() {
    ...
    checkvalidate = () =>{
        ...
        data.append('whoweare',inp_htmlcode);
        $(".error").remove();
    ...
    axios.post('{{ENV("APP_URL")}}/updatewho',data).then((result) => {
     if(result.data == 1){
          Swal.fire(
            'Thankyou!',
            'Who We Are Update Successfully !',
            'success',
            ).then((result) => {
             location.reload();
             });
